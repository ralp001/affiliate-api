...
namespace AffiliateMarketing.Infrastructure.Migrations
{
    ...
    [Migration("20260303181946_Initial_Stable_Demo_V1")]
    partial class Initial_Stable_Demo_V1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AffiliateMarketing.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommissionValue = 15m,
                            Currency = "NGN",
                            Description = "Enterprise-grade cybersecurity training and role-play simulation.",
                            IsAvailableForAffiliates = true,
                            Name = "CyberRole Defense Pro"
                        });
                });
